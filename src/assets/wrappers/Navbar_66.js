...
.header {
    ...
    display: flex;
    height: 15vh;
    border-bottom: #e9900a 1px solid;
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
...
@media (min-width: 48em) {
  ...
  .header .header-row .header-right .main-menu li.dropdown:hover {
    font-weight: 900;
  }
  .header .header-row .header-right .main-menu li.dropdown:hover a{
    color: grey;
  }
  ...
  .header .header-row .header-right .main-menu li.menu-item:hover .sub-menu-wrapper li.menu-item > a:hover {
    color: black;
    font-weight:900;
  }
