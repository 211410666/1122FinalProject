    ...
    const CaltoInfix = () => {
        ...
        for (let i = 0; i <charArray.length; i++) {
            if ((charArray[i] >= 'a' && charArray[i] <= 'z')||(charArray[i] >= 'A' && charArray[i] <= 'Z')) stack.push(charArray[i]);
                ...
                let newinfix = op1 + charArray[i] + op2;
            ...
            <div className='pages'>
                <div className='section'>
                    ...
                    <section className='section-content'>
                        <p>以運算元+運算子的組合依次將所有組合括號起來，並將運算子取代前方的左括號，並將得到的算式再次括號起來，即可得到中序式。</p>
                        <br />
                        <p>以這個運算式為例</p>
                        ...
                        <p className='phighlight'>ABC^/DE*+AC*-</p>
                        <p> -&gt; </p>
                        <p className='phighlight'>AB(C^)/DE*+AC*-</p>
                        <p> -&gt; </p>
                    ...
                    <section className='section-content'>
                        <p>堆疊法的原則:</p>
                        <br />
                        <p>1.由左至右讀取字元(前序由右至左)</p>
                        <br />
                        <p>2.如果讀入運算元則堆疊進Stack</p>
                        <br />
                        <p>3.如果讀入運算子則從Stack中pop兩個運算元，取出兩個運算元結合成一個中序式，然後把結果推入堆疊</p>
                        <br />
                        <p>4.前序的結合規則為[運算元1][運算子][運算元2](前序則相反)</p>
                        <br />
                        <p>5.若取出的為運算式需要特別判斷是否需要加括號，若為運算元2，優先度小於等於目前讀取的運算子則需要把右運算式加上括號. 而如果是運算元1,優先度小於目前讀取的運算子則需要把左運算式加上括號</p>
                        <br />
                        <p>以下是過程解析:</p>
                        <br />
                        <p>原式:</p><p className='phighlight'>ABC^/DE*+AC*-</p>
                        <p>　Stack : </p><p className='phighlight'>[空]</p>
                        <p>　</p>
                        <br />
                        <p>原式:</p><p className='phighlight'>BC^/DE*+AC*-</p>
                        <p>　Stack : </p><p className='phighlight'>[A]</p>
                        <p>　讀到A，推入堆疊</p>
                        <br />
                        <p>原式:</p><p className='phighlight'>C^/DE*+AC*-</p>
                        <p>　Stack : </p><p className='phighlight'>[AB]</p>
                        <p>　讀到B，推入堆疊</p>
                        <br />
                        <p>原式:</p><p className='phighlight'>^/DE*+AC*-</p>
                        <p>　Stack : </p><p className='phighlight'>[ABC]</p>
                        <p>　讀到C，推入堆疊</p>
                        <br />
                        <p>原式:</p><p className='phighlight'>/DE*+AC*-</p>
                        <p>　Stack : <p className='phighlight'>[A(B^C)]</p></p>
                        <p>　讀到^，取出兩個運算元結合成中序式B^C，將結果推入堆疊</p>
                        <br />
                        <p>原式:</p><p className='phighlight'>DE*+AC*-</p>
                        <p>　Stack : </p><p className='phighlight'>[(A/B^C)]</p>
                        <p>　讀到/，取出兩個運算元結合成中序式A/B^C，將結果推入堆疊</p>
                        <br />
                        <p>原式:</p><p className='phighlight'>E*+AC*-</p>
                        <p>　Stack : </p><p className='phighlight'>[(A/B^C)D]</p>
                        <p>　讀到D，推入堆疊</p>
                        <br />
                        <p>原式:</p><p className='phighlight'>*+AC*-</p>
                        <p>　Stack : </p><p className='phighlight'>[(A/B^C)DE]</p>
                        <p>　讀到E，推入堆疊</p>
                        <br />
                        <p>原式:</p><p className='phighlight'>+AC*-</p>
                        <p>　Stack : </p><p className='phighlight'>[(A/B^C)(D*E)]</p>
                        ...
                        <p>　Stack : </p><p className='phighlight'>[(A/B^C+D*E)A]</p>
                        <p>　讀到A，推入堆疊</p>
                        <br />
                        <p>原式:</p><p className='phighlight'>*-</p>
                        <p>　Stack : </p><p className='phighlight'>[(A/B^C+D*E)AC]</p>
                        <p>　讀到C，推入堆疊</p>
                        <br />
                        <p>原式:</p><p className='phighlight'>-</p>
...
export default DataStructPostfix;